...
course_data <- readRDS("~/Documents/R Shiny Learning/Data/europe.rds") %>% # Load the course data
      ...
      mainPanel(
        ...
        tabsetPanel(type = "tabs",
                    tabPanel(title = "Info",
                           ...
                           exercises using the europe.rds data:"), strong("Average daily temperatures (in Fahrenheit) from cities around
                    ...
                    tabPanel(title = "Plots",
                             fluidRow(
                               column( width = 12, plotOutput(outputId = "barplot"))
                             ),
                             fluidRow(
                               column( width = 6, plotOutput(outputId = "lineplot"))
                             ),
                             fluidRow(
                               column( width = 6, plotOutput(outputId = "boxplot"))
                             )
